/* textos.js — dados dos textos (mantido em window.textos) */
window.textos = [
  {
    id: 1,
    titulo: "📱 Por que é tão difícil ficar sem celular?",
    categoria: "Crônica",
    resumo: "Por que é tão difícil ficar sem celular? Uma reflexão sobre nossa dependência do celular.",
    favorito: false,
...
talvez o tempo seja o que mais dá falta.`
  },
  {
    ...
    titulo: "A Semente",
    categoria: "Fábula",
    resumo: "A Semente: Uma breve história sobre paciência e amadurecimento.",
    favorito: true,
    conteudo: `A Semente

Essa é a história de um fazendeiro que tinha um sonho: conseguir uma semente especial. Ele sonhava com ela todos os dias, mas a semente era cara demais para seu bolso.
...
Perdeu seu maior hobby, a jardinagem, que o fazia feliz todos os dias, e sua própria alimentação, já que dependia do que plantava. Todas as terras, fruto de anos de trabalho, agora estavam longe de seu alcance.
O valor da semente era imenso para ele — sentimental e monetário —, mas, sem meios para mantê-la, ela acabou apodrecendo com o tempo, tornando-se inútil. O fazendeiro, agora sem plantação, sem sementes e sem dinheiro, se vê perdido, tendo que reconstruir do zero tudo o que havia construído em anos.
Hum… familiar essa história.`
  },
  {
    ...
    titulo: "Muros Falsos",
    categoria: "Crônica",
    resumo: "Muros Falsos: Sobre problemas familiares e o desejo de paz.",
    favorito: true,
