/* textos.js — dados dos textos (window.textos) */
/* IDs iniciam em 0 para facilitar indexação */
window.textos = [
  {
    id: 0,
    titulo: "📱 Por que é tão difícil ficar sem celular?",
    categoria: "Crônica",
    resumo: "Por que é tão difícil ficar sem celular? Uma reflexão sobre nossa dependência digital.",
    favorito: false,
...
talvez o tempo seja o que mais dá falta.`
...

  {
    ...
    favorito: true, // você pediu: A Semente deve ser favorito
...
Hum… familiar essa história.`
...

  {
    ...
    favorito: true, // você pediu: Muros Falsos deve ser favorito
